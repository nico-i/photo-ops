...
const (
	...
	MotifService_GetNoBGImage_FullMethodName   = "/motif.MotifService/GetNoBGImage"
)
...
type MotifServiceClient interface {
	...
	GetNoBGImage(ctx context.Context, in *ImageRequest, opts ...grpc.CallOption) (*ImageResponse, error)
}
...
func (c *motifServiceClient) GetNoBGImage(ctx context.Context, in *ImageRequest, opts ...grpc.CallOption) (*ImageResponse, error) {
	out := new(ImageResponse)
	err := c.cc.Invoke(ctx, MotifService_GetNoBGImage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// All implementations should embed UnimplementedMotifServiceServer
// for forward compatibility
type MotifServiceServer interface {
	// Returns bounding box information for the subject in the image.
	GetBoundingBox(context.Context, *ImageRequest) (*BoundingBoxResponse, error)
	// Returns an image with the background removed.
	GetNoBGImage(context.Context, *ImageRequest) (*ImageResponse, error)
}

// UnimplementedMotifServiceServer should be embedded to have forward compatible implementations.
...
func (UnimplementedMotifServiceServer) GetNoBGImage(context.Context, *ImageRequest) (*ImageResponse, error) {
...
func _MotifService_GetNoBGImage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ImageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MotifServiceServer).GetNoBGImage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MotifService_GetNoBGImage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MotifServiceServer).GetNoBGImage(ctx, req.(*ImageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MotifService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetNoBGImage",
			Handler:    _MotifService_GetNoBGImage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "motif/motif.proto",
}
