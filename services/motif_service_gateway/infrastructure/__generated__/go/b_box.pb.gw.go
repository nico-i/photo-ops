...
/*
Package motif_service is a reverse proxy.
...
func RegisterBBoxServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BBoxServiceServer) error {
	...
	mux.Handle("POST", pattern_BBoxService_GetBBox_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.BBoxService/GetBBox", runtime.WithHTTPPathPattern("/v1/bbox"))
		if err != nil {
	...
	mux.Handle("POST", pattern_BBoxService_GetBBoxDebug_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.BBoxService/GetBBoxDebug", runtime.WithHTTPPathPattern("/v1/bbox/debug"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterBBoxServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BBoxServiceClient) error {
	...
	mux.Handle("POST", pattern_BBoxService_GetBBox_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.BBoxService/GetBBox", runtime.WithHTTPPathPattern("/v1/bbox"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("POST", pattern_BBoxService_GetBBoxDebug_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.BBoxService/GetBBoxDebug", runtime.WithHTTPPathPattern("/v1/bbox/debug"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
