...
const (
	BBoxService_GetBBox_FullMethodName      = "/application.bbox.BBoxService/GetBBox"
	BBoxService_GetBBoxDebug_FullMethodName = "/application.bbox.BBoxService/GetBBoxDebug"
)
...
type BBoxServiceClient interface {
	...
	GetBBox(ctx context.Context, in *value_objects.Image, opts ...grpc.CallOption) (*value_objects.BBox, error)
	// Returns the image used to generate the bounding box with the bounding box drawn on it.
	GetBBoxDebug(ctx context.Context, in *value_objects.Image, opts ...grpc.CallOption) (*value_objects.BBox, error)
}
...
func (c *bBoxServiceClient) GetBBox(ctx context.Context, in *value_objects.Image, opts ...grpc.CallOption) (*value_objects.BBox, error) {
	out := new(value_objects.BBox)
...
func (c *bBoxServiceClient) GetBBoxDebug(ctx context.Context, in *value_objects.Image, opts ...grpc.CallOption) (*value_objects.BBox, error) {
	out := new(value_objects.BBox)
...
type BBoxServiceServer interface {
	// Returns bounding box information for the subject in the image.
	GetBBox(context.Context, *value_objects.Image) (*value_objects.BBox, error)
	// Returns the image used to generate the bounding box with the bounding box drawn on it.
	GetBBoxDebug(context.Context, *value_objects.Image) (*value_objects.BBox, error)
...
func (UnimplementedBBoxServiceServer) GetBBox(context.Context, *value_objects.Image) (*value_objects.BBox, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBBox not implemented")
}
func (UnimplementedBBoxServiceServer) GetBBoxDebug(context.Context, *value_objects.Image) (*value_objects.BBox, error) {
...
func _BBoxService_GetBBox_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BBoxServiceServer).GetBBox(ctx, req.(*value_objects.Image))
	}
...
func _BBoxService_GetBBoxDebug_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BBoxServiceServer).GetBBoxDebug(ctx, req.(*value_objects.Image))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BBoxService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "application.bbox.BBoxService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBBoxDebug",
			Handler:    _BBoxService_GetBBoxDebug_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "application/bbox/bbox_service.proto",
}
